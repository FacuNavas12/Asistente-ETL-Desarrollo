...
**Append-only**, citado desde código — mismo criterio que `hallazgos.md`/`decisiones.md`: una entrada se agrega, no se reescribe; si su estado cambia, se edita solo la línea `**Estado:**`.
